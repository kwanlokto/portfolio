...
/**
 * Module-level constant on purpose: defining this inline in the reader
 * allocated 16 new component identities on every render, so react-markdown
 * could never bail out of re-rendering a node.
 */
