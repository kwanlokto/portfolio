export const sections = [
  {
    ...
    content: (
      <>
        <p>
          Being pragmatic isn't about taking shortcuts. It's about making smart
          tradeoffs. You write code that works <em>and</em> lasts. You solve real
          problems instead of just flexing your technical chops. You get better
          over time, and you take ownership of what you ship.
        </p>
        <p>
          The book frames software development as something you can practice and
          master, like woodworking or cooking. Not something you just “do.”
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Early on, the book drops this line: “Don't live with broken windows.”
          Meaning: if you see messy code, unclear docs, or failing tests — fix
          them. Or at least don't ignore them. Little problems pile up into
          technical debt that'll crush you later.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          You've probably heard this one. But it's not just about copy-pasting.
          It's about duplicated <em>logic</em>, duplicated <em>knowledge</em>,
          duplicated <em>assumptions</em>. When something needs to change, you
          want to change it in exactly one place.
        </p>
        <p>
    ...
    content: (
      <>
        <p>
          ...
          instead of optimizing for today's features, optimize for flexibility.
        </p>
        <p>
    ...
    content: (
      <>
        <p>
          ...
          learn the shortcuts. Saving a few seconds dozens of times a day? That
          compounds into real productivity.
        </p>
        <p>
